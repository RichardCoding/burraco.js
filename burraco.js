...
function draw() {
  ...
  if (numerino == 1) {
    ...
    stroke(0);
    text(pinella,87,100);
    text(pinella,235,100);
    text(pinella,87,334);
    text(pinella,235,334);
    text(pinella,160,215);
  } else if (numerino == 14) {
    fill(0)
    stroke(0);
    text(jolly,87,100);
    ...
    fill(200,200,200);
    stroke(200,200,200);
    rect(90,80,435,200,10);

    // Scritta:
    fill(0);
    stroke(0);
    textFont("Arial",[64]);
    text("Burraco Pulito.",100,200);
    ...
    stroke(0);
    text(quattro,87,100);
    text(quattro,205,100);
    text(quattro,87,334);
    text(quattro,205,334);
    text(quattro,160,215);
  } else if (numerino == 21) {
    fill(0);
    stroke(0);
    ...
    stroke(0);
    text(pinella,87,100);
    text(pinella,205,100);
    text(pinella,87,334);
    text(pinella,205,334);
    text(pinella,160,215);
  } else if (numerino == 31) {
    fill(0);
    stroke(0);
...
if (mouseX >= 80 && mouseX <= 265 && mouseY >= 60 && mouseY <= 340) {
    ...
    } else if (numerino == 19 || numerino == 20 || numerino == 21 || numerino == 22 || numerino == 23) {
      meno_tre_sette += 1;
      console.log(meno_tre_sette)
    } else if (numerino == 24 || numerino == 25 || numerino == 26 || numerino == 27 || numerino == 28 || numerino == 29) {
      meno_otto_re += 1;
    ...
    if (numerino < 17 || numerino >= 18 && numerino < 33)  {
      numerino += 1;
    } else if (numerino = 17) {

      if (numerino == 17 && chiusura == 1) {
        punti_chiusura = 100;
        numerino = 50;
        console.log(numerino);
      } else if (numerino == 17 && chiusura == 0) {
        numerino += 1;
